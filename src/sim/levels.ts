...
export const LEVELS: LevelDef[] = [
  {
    ...
    boss: boss({ id: 'donald-rump', name: 'Donald Rump', drawnBy: NOVA, drawing: 'donald-rump.jpg', speed: 2.2, chargeSpeed: 9, damage: 15, scale: 2.6, taunt: 'Tremendous baby. The best baby. Sad!', beaten: 'Fake baby! Very unfair! I am leaving!' }),
