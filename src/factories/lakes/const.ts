...
export interface LakeData {
	...
	radius: number;
	depth: number; // Maximum depth of lake below edge
	waterLevel: number; // Height at the edge of the lake (all water must be below this)
	blendDistance: number; // Terrain height blending distance
}

// Terrain constants redefined here to avoid 'Cannot access before initialization'
const MAX_TERRAIN_HEIGHT = 14;
const SAND_HEIGHT = MAX_TERRAIN_HEIGHT * 0.06;
